...
<section id="admin-detail-laporan-bap">
    <div class="container">
        <div class="card">
            ...
            {!!Form::open(['action'=>['PimpinanController@showBAPPeriodePimpinan', $dlbp->id_periode], 'method'=>'GET'])!!}
                {{Form::hidden('id_periode',"$dlbp->id_periode")}}
                {{Form::submit('Kembali Ke Laporan Periode',['class'=>'btn btn-primary mt-5'])}}
            {!!Form::close()!!}
        </div><!--card-->
    </div><!--container-->
</section>    
