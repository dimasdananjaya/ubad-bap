...
<section id="admin-show-laporan-bap-periode">
    <div class="container-fluid">
        <div class="card">
            ...
            <hr>
            <table class="table table-lg table-hover table-striped table-responsive-sm table-responsive-md table-bordered" id="tabel-laporan-bap">
                <thead>
                    <th>No.</th>
                    <th>Nama</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {!!Form::open(['action'=>['PimpinanController@detailLaporanBAPPimpinan', $dlbu->id_user], 'method'=>'GET'])!!}
            ...
            <p><a class="btn btn-primary mb-5 mb-md-0 mt-4" href="{{route('pimpinan.pilih.periode.laporan')}}">Kembali ke Pilih Periode</a></p>
    ...
    window.onload = function() {
        ...
        window.myBar = new Chart(ctx, {
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: 'Chart SKS Mengajar (buka melalui laptop/pc)'
                }
            }
        });
