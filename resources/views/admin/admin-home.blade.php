...
<section id="admin-home">
    <div class="container">
        <div class="card">
            ...
            <hr>
            <div class="row">
                <div class="col-12 ml-auto col-md-6 col-lg-4">
                ...
                <div class="col-12 ml-auto col-md-6 col-lg-4">
                    <img class="img-fluid" src="{{asset('resources/logo/users.svg')}}">
                    <h4>Kelola Users</h4>
                    <p>Kelola Data Users</p>
                    <p><a class="btn btn-primary mb-5 mb-md-0" href="{{route('admin.users')}}">Pilih</a></p>
                </div><!--col-->
